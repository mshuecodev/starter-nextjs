...
import { latestInvoices } from "@/app/lib/placeholder-data"
							...
							>
								...
								<div className="flex w-full items-center justify-between pt-4">
									<div>
										...
										<p>{invoice.date && formatDateToLocal(invoice.date)}</p>
									</div>
						...
						<tbody className="bg-white">
							{invoices?.map((invoice) => (
								...
								>
									...
									<td className="whitespace-nowrap px-3 py-3">{invoice.date && formatDateToLocal(invoice.date)}</td>
